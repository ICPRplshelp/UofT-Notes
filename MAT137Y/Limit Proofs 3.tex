...
\includegraphics[width=2.08125in,height=1.34028in]{TEXIMAGEF_Limit Proofs 3/media/image1.png}
...
\includegraphics[width=4in,height=0.67917in]{TEXIMAGEF_Limit Proofs 3/media/image2.png}
...
\includegraphics[width=3.55484in,height=1.89359in]{TEXIMAGEF_Limit Proofs 3/media/image3.png}
...
$$\begin{matrix}
\lim(f)\ \text{and}\lim(g)\ \text{exists} \Rightarrow \lim(f + g) = \lim(f) + \lim(g)\ \#(1) \\
\end{matrix}$$
...
$$\begin{matrix}
\lim(f)\ \text{and}\lim(g)\ \text{exists} \Rightarrow \lim(f + g)\lim(f - g) = \lim(f) - \lim(g)\ \#(2) \\
\end{matrix}$$
...
\emph{Proof.} Suppose $\lim_{x \rightarrow a}{g(x)}$ exists. We know
$\lim_{x \rightarrow a}\left\lbrack f(x) + g(x) \right\rbrack$ exists.
...
$$\begin{matrix}
\lim_{x \rightarrow a}{f\left( g(x) \right) = f\left\lbrack \lim_{x \rightarrow a}{g(x)} \right\rbrack}\ \#(1) \\
\end{matrix}$$
...
$$\begin{matrix}
\lim_{x \rightarrow \lim_{x \rightarrow a}{g(x)}}{f(x)} = f\left\lbrack \lim_{x \rightarrow a}{g(x)} \right\rbrack\ \#(2) \\
\end{matrix}$$
...
$$\begin{matrix}
\forall\epsilon > 0,\ \exists\delta > 0,\ 0 < |x - a| < \delta \Rightarrow \left| f\left( g(x) \right) - f\left\lbrack \lim_{x \rightarrow a}{g(x)} \right\rbrack \right| < \epsilon\#\left( 3,\ \text{To\ show} \right) \\
\end{matrix}$$
...
$$\begin{matrix}
\forall\epsilon_{2} > 0,\exists\delta_{2} > 0,0 < \left| x_{2} - \lim_{x \rightarrow a}{g(x)} \right| < \delta_{2} \Rightarrow \left| f\left( x_{2} \right) - f\left( \lim_{x \rightarrow a}{g(x)} \right) \right| < \epsilon_{2}\ \#\left( 4,\ \text{True} \right) \\
\end{matrix}$$
...
\emph{Proof.} Let $\epsilon > 0$. Pick $\epsilon_{2} = \_\_$, which
makes the statement below true.

$$\begin{matrix}
\exists\delta_{2} > 0,\ 0 < \left| x_{2} - \lim_{x \rightarrow a}{g(x)} \right| < \delta_{2} \Rightarrow \left| f\left( x_{2} \right) - f\left( \lim_{x \rightarrow a}{g(x)} \right) \right| < \epsilon_{2}\ \#\left( 5,\ \text{True} \right) \\
\end{matrix}$$
...
$$\begin{matrix}
\forall\epsilon_{2} > 0,\exists\delta_{2} > 0,0 < \left| g(x) - \lim_{x \rightarrow a}{g(x)} \right| < \delta_{2} \Rightarrow \left| f\left( g(x) \right) - f\left( \lim_{x \rightarrow a}{g(x)} \right) \right| < \epsilon\ \#\left( 6,\ \text{True} \right) \\
\end{matrix}$$
...
\includegraphics[width=3.81655in,height=1.13314in]{TEXIMAGEF_Limit Proofs 3/media/image4.png}

There is an implicit assumption that
$\lim_{x \rightarrow a}{g(x)} = M$ exists. Then, we know that

$$\begin{matrix}
\forall\epsilon_{3} > 0,\ \exists\delta_{3} > 0,\ 0 < \left| x_{3} - a \right| < \delta_{3} \Rightarrow \left| g\left( x_{3} \right) - \lim_{x \rightarrow a}{g(x)} \right| < \epsilon_{3}\ \#\left( 7,\ \text{True} \right) \\
\end{matrix}$$
...
\includegraphics[width=3.65405in,height=2.18417in]{TEXIMAGEF_Limit Proofs 3/media/image5.png}
...
\includegraphics[width=2.73039in,height=2.04145in]{TEXIMAGEF_Limit Proofs 3/media/image6.png}
...
\includegraphics[width=3.92823in,height=1.49526in]{TEXIMAGEF_Limit Proofs 3/media/image7.png}
...
\includegraphics[width=1.25373in,height=1.03788in]{TEXIMAGEF_Limit Proofs 3/media/image8.png}
...
\includegraphics[width=6.25087in,height=1.06265in]{TEXIMAGEF_Limit Proofs 3/media/image9.png}
...
\includegraphics[width=6.41756in,height=1.95861in]{TEXIMAGEF_Limit Proofs 3/media/image10.png}
...
\includegraphics[width=6.18836in,height=0.91679in]{TEXIMAGEF_Limit Proofs 3/media/image11.png}
...
\item
  -\\
  \includegraphics[width=6.5in,height=2.02986in]{TEXIMAGEF_Limit Proofs 3/media/image12.png}
\end{enumerate}
...
\includegraphics[width=2.33333in,height=1.22685in]{TEXIMAGEF_Limit Proofs 3/media/image13.png}
...
\begin{align*}
&\lim_{x \rightarrow \pm \infty}\left( \frac{x^{3}}{x^{2} + 1} \right)
\end{align*}
...
\includegraphics[width=6.38631in,height=1.58355in]{TEXIMAGEF_Limit Proofs 3/media/image14.png}

Simplify stuff the moment you take the derivative.

\includegraphics[width=5.79247in,height=2.13572in]{TEXIMAGEF_Limit Proofs 3/media/image15.png}
